...
export const IPIP_NEO_20_ITEMS: BigFiveItem[] = [
  ...
  {
    id: 3,
    text: "Me sinto confortável perto de pessoas",
  ...
  {
    id: 8,
    text: "Não me interesso muito pelos outros",
    dimension: "agreeableness",
    reversed: true,
  },
...
export const DISC_ITEMS: DISCItem[] = [
  {
    id: 1,
    a: { text: "Gosto de assumir o controle das situações", dimension: "D" },
    b: { text: "Prefiro colaborar e apoiar os outros", dimension: "S" },
  },
  {
    id: 2,
    a: { text: "Sou entusiasta e otimista", dimension: "I" },
    b: { text: "Sou meticuloso e analítico", dimension: "C" },
  },
  {
    id: 3,
    a: { text: "Busco resultados rápidos e diretos", dimension: "D" },
    b: { text: "Valorizo relacionamentos e harmonia", dimension: "I" },
  },
  {
    id: 4,
    a: { text: "Sou paciente e bom ouvinte", dimension: "S" },
    b: { text: "Sou preciso e detalhista", dimension: "C" },
  },
  {
    id: 5,
    a: { text: "Tomo decisões rápidas e firmes", dimension: "D" },
    b: { text: "Analiso todos os dados antes de decidir", dimension: "C" },
  },
  {
    id: 6,
    a: { text: "Gosto de convencer e influenciar pessoas", dimension: "I" },
    b: { text: "Prefiro manter a estabilidade e rotina", dimension: "S" },
  },
  {
    id: 7,
    a: { text: "Aceito desafios com confiança", dimension: "D" },
    b: { text: "Inspiro e motivo os outros com entusiasmo", dimension: "I" },
  },
  {
    id: 8,
    a: { text: "Sou leal e consistente no meu trabalho", dimension: "S" },
    b: { text: "Sigo regras e procedimentos rigorosamente", dimension: "C" },
  },
  {
    id: 9,
    a: { text: "Sou competitivo e orientado a metas", dimension: "D" },
    b: { text: "Sou cooperativo e busco consenso", dimension: "S" },
  },
  {
    id: 10,
    a: { text: "Gosto de socializar e conhecer pessoas novas", dimension: "I" },
    b: { text: "Prefiro trabalhar com fatos e lógica", dimension: "C" },
  },
  {
    id: 11,
    a: { text: "Sou determinado e persistente", dimension: "D" },
    b: { text: "Sou criativo e expressivo na comunicação", dimension: "I" },
  },
  {
    id: 12,
    a: { text: "Valorizo previsibilidade e segurança", dimension: "S" },
    b: { text: "Busco qualidade e excelência nos detalhes", dimension: "C" },
  },
  {
    id: 13,
    a: { text: "Prefiro liderar e delegar tarefas", dimension: "D" },
    b: { text: "Prefiro seguir instruções claras", dimension: "C" },
  },
  {
    id: 14,
    a: { text: "Sou expressivo e gosto de falar em público", dimension: "I" },
    b: { text: "Sou reservado e prefiro ouvir", dimension: "S" },
  },
  {
    id: 15,
    a: { text: "Gosto de resolver problemas difíceis", dimension: "D" },
    b: { text: "Gosto de ajudar os outros a se sentirem bem", dimension: "I" },
  },
  {
    id: 16,
    a: { text: "Sou calmo e ponderado sob pressão", dimension: "S" },
    b: { text: "Sou cuidadoso e verifico tudo duas vezes", dimension: "C" },
  },
  {
    id: 17,
    a: { text: "Sou assertivo e direto ao ponto", dimension: "D" },
    b: { text: "Sou diplomático e atencioso", dimension: "S" },
  },
  {
    id: 18,
    a: { text: "Gosto de ambientes animados e dinâmicos", dimension: "I" },
    b: { text: "Prefiro ambientes organizados e estruturados", dimension: "C" },
  },
  {
    id: 19,
    a: { text: "Assumo riscos calculados para avançar", dimension: "D" },
    b: { text: "Evito riscos e prefiro o caminho seguro", dimension: "S" },
  },
  {
    id: 20,
    a: { text: "Sou persuasivo e comunicativo", dimension: "I" },
    b: { text: "Sou sistemático e organizado", dimension: "C" },
  },
  {
    id: 21,
    a: { text: "Foco em resultados acima de tudo", dimension: "D" },
    b: { text: "Foco em pessoas e relacionamentos", dimension: "I" },
  },
  {
    id: 22,
    a: { text: "Sou confiável e previsível", dimension: "S" },
    b: { text: "Sou criterioso e exigente com qualidade", dimension: "C" },
  },
  {
    id: 23,
    a: { text: "Gosto de mudar e inovar processos", dimension: "D" },
    b: { text: "Gosto de celebrar conquistas em equipe", dimension: "I" },
  },
  {
    id: 24,
    a: { text: "Sou pacificador e evito conflitos", dimension: "S" },
    b: { text: "Sou objetivo e baseado em evidências", dimension: "C" },
  },
  {
    id: 25,
    a: { text: "Sou impaciente com resultados lentos", dimension: "D" },
    b: { text: "Sou paciente e dou tempo para as coisas acontecerem", dimension: "S" },
  },
  {
    id: 26,
    a: { text: "Gosto de trabalhar em equipe animada", dimension: "I" },
    b: { text: "Prefiro trabalhar sozinho com concentração", dimension: "C" },
  },
  {
    id: 27,
    a: { text: "Priorizo eficiência e velocidade", dimension: "D" },
    b: { text: "Priorizo precisão e conformidade", dimension: "C" },
  },
  {
    id: 28,
    a: { text: "Sou otimista e vejo oportunidades", dimension: "I" },
    b: { text: "Sou realista e vejo riscos potenciais", dimension: "S" },
  },
]
...
export function scoreDISC(answers: Record<number | string, "a" | "b">): DISCResult {
  ...
  const floored = rawPcts.map((p) => ({
    ...p,
    floor: Math.floor(p.val),
    remainder: p.val - Math.floor(p.val),
  }))
...
export const MULTIPLE_INTELLIGENCES_ITEMS: MultipleIntelligencesItem[] = [
  ...
  {
    id: 4,
    text: "Gosto de contar histórias e explicar ideias verbalmente",
  ...
  {
    id: 25,
    text: "Prefiro aprender com as mãos — montar, construir, experimentar",
  ...
  {
    id: 30,
    text: "Me adapto facilmente a diferentes grupos sociais",
  ...
  {
    id: 32,
    text: "Gosto de refletir sobre meus sentimentos e motivações",
  ...
  {
    id: 35,
    text: "Entendo minhas reações emocionais e consigo gerenciá-las",
    intelligence: "intrapersonal",
  },
  // Naturalist (5 items)
  ...
  {
    id: 37,
    text: "Gosto de classificar e organizar elementos naturais",
    intelligence: "naturalist",
  },
  { id: 38, text: "Me sinto conectado com o meio ambiente", intelligence: "naturalist" },
  {
    id: 39,
    text: "Tenho interesse em plantas, animais ou fenômenos naturais",
    intelligence: "naturalist",
  },
  {
    id: 40,
    text: "Percebo mudanças sutis no clima, estações ou paisagens",
    intelligence: "naturalist",
  },
]
...
export function scoreMultipleIntelligences(
...
export const CAREER_ANCHORS_ITEMS: CareerAnchorsItem[] = [
  ...
  {
    id: 1,
    text: "Me realizo quando me torno especialista em uma área técnica",
    anchor: "technical",
  },
  ...
  {
    id: 4,
    text: "Ficaria insatisfeito se nao pudesse aprofundar minha expertise",
    anchor: "technical",
  },
  ...
  {
    id: 10,
    text: "Gosto de lidar com problemas complexos e multifuncionais",
    anchor: "management",
  },
  // Autonomy/Independence (5 items)
  {
    id: 11,
    text: "Preciso de liberdade para definir meu próprio ritmo de trabalho",
    anchor: "autonomy",
  },
  ...
  {
    id: 20,
    text: "Evitaria mudar de emprego se isso comprometesse minha estabilidade",
    anchor: "security",
  },
  ...
  {
    id: 24,
    text: "Estou disposto a correr riscos para criar algo novo",
  ...
  {
    id: 32,
    text: "Me motivo quando enfrento problemas aparentemente impossíveis",
    anchor: "challenge",
  },
  ...
  {
    id: 37,
    text: "Recusaria uma promoção se prejudicasse minha qualidade de vida",
    anchor: "lifestyle",
  },
  { id: 38, text: "Quero flexibilidade para conciliar trabalho e família", anchor: "lifestyle" },
  {
    id: 39,
    text: "Minha carreira deve se integrar harmoniosamente à minha vida",
    anchor: "lifestyle",
  },
