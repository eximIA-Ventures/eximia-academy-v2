...
export function ProfilePageClient({
  ...
  return (
    <div className="space-y-8">
      {/* Page header */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-bg-card via-bg-surface to-varzea-dark/30 p-6 shadow-card md:p-8">
        <div className="relative z-10">
          <p className="text-[10px] font-semibold uppercase tracking-[0.15em] text-varzea-light">
            Conta
          </p>
        ...
        <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-varzea/15 blur-3xl" />
        <div className="absolute -bottom-8 left-1/3 h-32 w-32 rounded-full bg-varzea-light/10 blur-3xl" />
      </div>
