...
const ENNEAGRAM_PARAGRAPHS = [
  ...
  {
    typeNumber: 3,
    text: "Sou orientado a resultados e gosto de ter sucesso. Trabalho duro para alcançar meus objetivos e me adapto facilmente a diferentes situações. Valorizo eficiência e realização.",
  },
  {
    typeNumber: 4,
    text: "Sou uma pessoa sensível e criativa. Busco autenticidade e profundidade em tudo que faço. Tenho um mundo interior rico e valorizo a expressão das minhas emoções e individualidade.",
  },
  {
    typeNumber: 5,
    text: "Sou curioso e observador. Gosto de entender como as coisas funcionam e valorizo conhecimento e competência. Preciso de tempo sozinho para processar informações e recarregar energias.",
  },
  {
    typeNumber: 6,
    text: "Sou leal e responsável. Valorizo segurança e previsibilidade. Sou bom em antecipar problemas e me preparar para situações difíceis. Compromisso e confiança são fundamentais para mim.",
  },
  {
    typeNumber: 7,
    text: "Sou entusiasta e otimista. Gosto de novas experiências e possibilidades. Tenho muita energia e ideias, e prefiro manter as opções em aberto. Busco alegria e satisfação na vida.",
  },
  {
    typeNumber: 8,
    text: "Sou direto e decidido. Gosto de assumir o controle e proteger as pessoas ao meu redor. Valorizo força, justiça e independência. Não tenho medo de enfrentar desafios.",
  },
  {
    typeNumber: 9,
    text: "Sou pacífico e compreensivo. Busco harmonia e evito conflitos. Consigo ver diferentes perspectivas e valorizo a estabilidade. Sou paciente e aceito as pessoas como elas são.",
  },
]
...
export function EnneagramQuestionnaire({
  userId,
  savedProgress,
  onComplete,
  onBack,
}: EnneagramQuestionnaireProps) {
  ...
  return (
    <div>
      ...
      <p className="mb-2 text-sm text-text-secondary">
        Leia cada parágrafo e clique neles na ordem de quanto você se identifica: o primeiro clique
        indica o parágrafo com que você MAIS se identifica.
      </p>
              ...
              <div className="flex items-start gap-3">
                <div
                  className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-xs font-bold ${
                    isRanked ? "bg-cerrado-600 text-white" : "bg-bg-surface text-text-muted"
                  }`}
                >
                  {isRanked ? position : "?"}
                </div>
