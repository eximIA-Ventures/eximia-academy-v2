...
import { AGORA_FIXTURE, entradaFixtureMapa } from "@/components/analytics/aprendizagem-time/fixture"
...
import { carregarMapaDoBanco } from "./leitura-real"

// ---------------------------------------------------------------------------
// /gauntlet-preview/aprendizagem-mapa-capacidades — harness visual DEV-ONLY da
// Tela 3 (Mapa de Capacidades). Mesmo contrato das outras rotas de preview de
// Aprendizagem.
//
// Screenshot: GAUNTLET_ROTA=aprendizagem-mapa-capacidades node scripts/gauntlet-shot.mjs out.png
// ---------------------------------------------------------------------------

export const dynamic = "force-dynamic"

const DESTINO_INERTE = {
  pathname: "/gauntlet-preview/aprendizagem-mapa-capacidades",
  query: "fonte=fixture",
}
...
export default async function GauntletAprendizagemMapaCapacidadesPreviewPage({
  searchParams,
}: {
  ...
  const dados = usarFixture ? entradaFixtureMapa() : await carregarMapaDoBanco(agoraDoMotor())
