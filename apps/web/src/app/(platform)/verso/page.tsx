...
import { getVersoCategories, getVersoPosts, toClientPost } from "@/lib/verso-queries"
    ...
    <div className="space-y-6">
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1457369804613-52c61a468e7d?w=1200&q=80')",
          }}
        />
        <div
        ...
        <div className="relative z-10 w-full px-8 pb-7">
          ...
          <h1 className="mt-2 text-3xl font-bold tracking-tight text-white md:text-4xl">Verso</h1>
          <p className="mt-3 max-w-lg text-sm leading-relaxed text-white/60 md:text-base">
            Não o que fazer, mas como pensar sobre o que fazer. Artigos de fundo sobre negócios,
