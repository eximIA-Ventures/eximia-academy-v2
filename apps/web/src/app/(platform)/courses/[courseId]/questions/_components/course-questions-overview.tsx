...
export function CourseQuestionsOverview({
  ...
  return (
    <div className="space-y-6 pb-24">
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-border-medium bg-bg-card/50 py-16 px-6 text-center space-y-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-text-muted max-w-md">
              Crie capítulos primeiro para configurar interações — Quiz, Cenários Práticos,
              Atividades e Diálogo Socrático.
            </p>
          </div>
                  ...
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <span
                          className={`text-xs ${chapter.interaction_type ? "text-text-secondary" : "text-semantic-warning"}`}
                        >
                          {INTERACTION_LABELS[chapter.interaction_type ?? ""] ??
                            "⚠ Interação não configurada"}
                        </span>
                        ...
                        {chapterQuestions.length > 0 && (
                          <span className="text-2xs text-text-muted">
                            · {chapterQuestions.length} pergunta
      ...
      {chapters.length > 0 && (
        <>
          <h2 className="text-sm font-semibold uppercase tracking-widest text-text-muted pt-2">
            Perguntas Geradas
          </h2>
