    ...
    <div className="space-y-6" role="status" aria-label="Carregando blueprint...">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="rounded-lg shadow-card bg-bg-card p-3 space-y-2">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-lg shadow-card bg-bg-card p-4 space-y-4">
        ...
        <div className="rounded-lg shadow-card bg-bg-card p-4 space-y-3">
      ...
      <div className="space-y-3">
        ...
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="rounded-lg shadow-card bg-bg-card p-4">
