    ...
    <div className={cn("flex gap-3", isAssistant ? "justify-start" : "flex-row-reverse")}>
      ...
      <div
        className={cn(
          ...
          isAssistant
            ? "bg-gradient-to-br from-accent-blue-mid to-accent-blue-deep text-white"
      ...
      <div
        className={cn(
          ...
          isAssistant
            ? "rounded-tl-sm bg-bg-card ring-1 ring-border-subtle text-text-primary"
            : "rounded-tr-sm bg-accent-blue-mid/15 text-text-primary ring-1 ring-accent-blue-mid/20",
        )}
      >
