        ...
        return (
          <button
            ...
            className={`relative flex-shrink-0 w-[72px] h-[40px] sm:w-24 sm:h-[54px] rounded-md overflow-hidden transition-all ${
              isActive
                ? "ring-[3px] ring-cerrado-600 shadow-[0_0_0_1px_rgba(42,106,176,0.15),0_0_8px_rgba(42,106,176,0.25)] scale-105"
                : "shadow-card hover:ring-border-primary opacity-70 hover:opacity-100"
            }`}
