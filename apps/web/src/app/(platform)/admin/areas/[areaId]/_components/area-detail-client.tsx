...
export function AreaDetailClient({
  ...
  async function assignCourse() {
    ...
    startTransition(async () => {
      ...
      toast({ variant: "success", title: "Curso atribuído à unidade!" })
  ...
  async function addUser() {
    ...
    startTransition(async () => {
      ...
      toast({ variant: "success", title: "Usuário adicionado!" })
  ...
  async function removeUser(userId: string) {
    startTransition(async () => {
      ...
      toast({ variant: "success", title: "Usuário removido da unidade" })
      router.refresh()
    })
  }
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-text-muted">
            {sessionCount} sessões · Métricas de profundidade, breakthroughs e desempenho
          </p>
        </div>
        <ArrowRight
          size={16}
      ...
      <div>
        ...
        {courses.length === 0 ? (
          <p className="rounded-2xl bg-bg-card shadow-card p-6 text-center text-sm text-text-muted">
            Nenhum curso atribuído. Cursos sem unidade são acessíveis por todos.
          </p>
        ) : (
              ...
              >
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold text-text-primary truncate group-hover:text-cerrado-600 transition-colors">
                      {c.title}
                    </p>
                  </div>
                </Link>
      ...
      <div>
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-base font-semibold text-text-primary">Usuários ({users.length})</h2>
      ...
      <Modal open={showAddUser} onOpenChange={setShowAddUser}>
        ...
        <ModalContent>
          <ModalHeader>
            <ModalTitle>Adicionar Usuário à Unidade</ModalTitle>
          </ModalHeader>
