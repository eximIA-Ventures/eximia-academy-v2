  ...
  return (
    ...
    >
      <head>
        ...
        <script
          // biome-ignore lint/security/noDangerouslySetInnerHtml: string literal estática hardcoded no código-fonte (script de tema), sem interpolação de dados de usuário ou tenant
